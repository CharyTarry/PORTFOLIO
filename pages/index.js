...
import chary from "../public/chary.png";
      ...
      <main className="">
        ...
        <section>
          <div>
            ...
            As a web designer and developer, I specialize in creating visually appealing and user-friendly websites that are optimized for search engines. I offer a range of services, including website design, web development, website maintenance, and website optimization. My goal is to help businesses and individuals create a strong online presence by providing professional and effective solutions that meet their needs and goals.
            </p>
          </div>
        ...
        <section className="py-10">
          ...
          <div className="flex flex-col gap-10 py-10 lg:flex-row lg:flex-wrap">
            <div className="basis-1/3 flex-1 ">
              <Link href="https://gpt3model.netlify.app/" target={"_blank"}>
                <Image
